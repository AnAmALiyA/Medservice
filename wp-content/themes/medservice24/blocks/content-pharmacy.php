<h1 class="post-title"><?php _e( ' Аптека', 'medservice24' ); ?></h1>
	<?php if(!empty($_POST['name']) && !empty($_POST['tel']) && !empty($_POST['email']) && !empty($_POST['messages'])):?>
		<div class="info-application">
			<?php get_template_part( 'blocks/popup_form/email-application-pharmacy', get_post_type());?> 
		</div>
	<?php endif;?>
<div class="wrap">
	<div class="wrap-img">
		...
		<?php endif;?>
		<strong class="title-name"><?php the_title( ); ?></strong>
		...
		<div class="post-box">
			...
			<div class="right-box">
				...
				<div class="col">
					...
					<a href="#popup4" class="btn lightbox"><?php _e( 'Задать вопрос', 'medservice24' ); ?></a>
