	...
	<main role="main" id="main">
		<section class="section">
			...
			<div class="personal-cab box clearfix">
                ...
                <div class="right-col">
                   <form action="#" class="dwnld form-medturism-list" name="form_medturism_list">
                    ...
                    <div class="download-holder clearfix">
                       <div class="dwnld">
                            <div class="form-holder">
                                <input type="text" required="required" class="form-control" id="name_medturism<?php echo $i ?>" name="name_medturism<?php echo $i ?>" placeholder="Заголовок"/>
                                
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                <i class="fa fa-times remove_item_js" aria-hidden="true"></i>
                                <textarea class="form-control" required="required" rows="5" id="comment_medturism<?php echo $i ?>" name="comment_medturism<?php echo $i ?>" placeholder="Описание"></textarea>
                            </div>
                        </div>
                    </div>
